...
def load_description(path):
	f = open(path)	
	keywords = ["dataPath", "atlasPath", "files", "ventModelPath","ventArchPath", "networksPath", "number", "outFileName"]
	types = ['string', 'string', 'liststring', 'string', 'string', 'string', 'string', 'string']
